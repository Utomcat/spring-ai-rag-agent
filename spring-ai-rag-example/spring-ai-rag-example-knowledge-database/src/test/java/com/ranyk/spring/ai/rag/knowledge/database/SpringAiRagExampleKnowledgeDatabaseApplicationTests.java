...
class SpringAiRagExampleKnowledgeDatabaseApplicationTests {
	...
	@Autowired
	private WeatherApiDefinitionBean weatherApiDefinitionBean;

	@Test
	@DisplayName("天气查询工具测试")
	void weatherForLocationToolTest() {
		String result = new WeatherForLocationToolFunction(objectMapper, weatherApiDefinitionBean).getWeatherForLocation("成都");
