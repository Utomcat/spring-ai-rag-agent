...
import com.ranyk.spring.ai.rag.knowledge.database.ai.tools.KnowledgeRetrievalToolFunction;
...
public class ChatClientConfiguration {
    ...
    /**
     * 创建一个 ChatClient Bean 对象 - 集成 Agent 能力
     *
     ...
     * @param knowledgeRetrievalToolFunction  知识库检索工具函数对象，{@link KnowledgeRetrievalToolFunction}
     * @param referenceExtractAdvisor         引用提取 Advisor 对象，{@link ReferenceExtractAdvisor}
    ...
    public ChatClient chatClient(
        ...
        log.info("正在创建 ChatClient，当前 ChatClient 集成了 Agent 能力：知识库检索工具、知识库文档工具、MCP Server 工具、引用提取 Advisor");
        log.info("注意，在此处设置了之后，全局使用的 ChatClient 均会带有设置的 Advisor、工具，为避免过度配置，请按需配置！");
        return ChatClient
