...
└── src/main/java/com/ranyk/spring/ai/rag/knowledge/database/
    ...
    │       └── SessionHistoryToolFunction.java  # 会话历史查询工具
    │
    ├── api/                         # REST API 接口层
