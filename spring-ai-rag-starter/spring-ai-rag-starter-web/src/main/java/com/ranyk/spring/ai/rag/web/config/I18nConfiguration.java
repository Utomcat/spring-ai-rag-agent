...
public class I18nConfiguration implements WebMvcConfigurer {
    ...
    public MessageSource messageSource() {
        log.debug("===========================  配置 MessageSource Bean start  =======================================");
        log.debug("配置 MessageSource Bean 处理中 ...");
        ...
        log.debug("===========================  配置 MessageSource Bean end    =======================================");
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        log.debug("===========================  添加 LocaleChangeInterceptor start  =======================================");
        log.debug("添加 LocaleChangeInterceptor 处理中 ...");
        LocaleChangeInterceptor interceptor = new LocaleChangeInterceptor();
        // 请求参数名，如?lang=zh_CN
        interceptor.setParamName("lang");
        registry.addInterceptor(interceptor);
        log.debug("===========================  添加 LocaleChangeInterceptor end    =======================================");
    }
}
